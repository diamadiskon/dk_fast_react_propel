...
module "keyvault" {
  ...
  agw_object_id         = module.role_assignment.user_assigned_identity_principal_id
...
module "agw" {
  ...
  url                   = module.host.app_brainbank_front_dev_url
  certificate_name      = module.keyvault.azurerm_key_vault_certificate_name
  appagumid             = module.role_assignment.user_assigned_identity_id
